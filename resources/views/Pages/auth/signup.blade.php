   ...
   <div class="login_box">
      <div class="left">
         <div class="contact">
            <form>
               <h3>SIGN UP</h3>
               <input type="text" name="username" placeholder="NAME / NICKNAME">
               <input type="number" name="age" min=19 placeholder="AGE">
      ...
      <div class="right">
         <div class="contact">
            <form>
               ...
               <input type="tel" name="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="PHONE" value="+82">
